...
var RegisterScreen = function (_a) {
    ...
    var _b = (0, authStore_1.useAuthStore)(), register = _b.register, loading = _b.loading, error = _b.error;
    ...
    var handleRegister = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, register(email, password)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
        ...
        <react_native_1.ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
          <react_native_1.View className="px-6 py-10 flex-1 justify-center">
            ...
            <react_native_1.View className="items-center mb-8">
              <react_native_1.Text className="text-2xl font-bold text-gray-800">アカウント登録</react_native_1.Text>
              <react_native_1.Text className="text-sm text-gray-500 mt-1">
                スタイルを見つける旅を始めましょう
              </react_native_1.Text>
            </react_native_1.View>
            ...
            <react_native_1.View className="space-y-4">
              ...
              <common_1.Input label="パスワード（確認）" placeholder="パスワードを再入力" value={confirmPassword} onChangeText={setConfirmPassword} isPassword error={validationErrors.confirmPassword} leftIcon={<vector_icons_1.Ionicons name="lock-closed-outline" size={20} color="#6B7280"/>}/>
            </react_native_1.View>

            {/* 登録ボタン */}
            <common_1.Button isFullWidth onPress={handleRegister} isLoading={loading} className="mt-6">
              登録する
            </common_1.Button>

            {/* ログインリンク */}
            <react_native_1.View className="flex-row justify-center mt-8">
              <react_native_1.Text className="text-gray-600">すでにアカウントをお持ちですか？</react_native_1.Text>
